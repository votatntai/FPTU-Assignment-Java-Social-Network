    ...
    <div class="col-md-6 mt-5 mx-auto">
        <div class="card p-3 card-bordered">
            <form action="LoginController" method="POST" id="form-login">
                ...
                <input type="submit" class="btn btn-primary float-right btn-block" name="action" value="Login">
            </form>
        </div>
    </div>
    <div class="col-md-6 my-5 mx-auto">
        <div class="card p-3 card-bordered">
            <form action="RegisterController" method="POST" id="form-register">
                ...
                <input type="submit" class="btn btn-info float-right btn-block" name="action" value="Register">
            </form>
        </div>
    </div>
</div>
